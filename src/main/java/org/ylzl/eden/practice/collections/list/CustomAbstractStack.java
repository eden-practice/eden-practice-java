...
import org.ylzl.eden.practice.collections.queue.CustomDeque;
 ...
 *
 * @see CustomAbstractLinkedList
 * @see CustomDeque
 * @author gyl
 * @since 2.0.0
 */
@Deprecated
public class CustomAbstractStack<E> extends CustomAbstractVector<E> {
